// sy- area: fills every <div class="kbd"></div> with a plain on-screen keyboard (typing states only).
  ...
  document.querySelectorAll('.kbd').forEach(function (k) {
    ...
    rows.forEach(function (r, ri) {
      ...
      r.forEach(function (c) {
        ...
        if (c === ' ') cls += ' space';
        // Inline svg, not <i data-i>: kit.js has already converted the <i> icons by the time this runs.
