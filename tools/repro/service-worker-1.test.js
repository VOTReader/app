...
import { registerServiceWorker } from '../../app/src/main/assets/src/utils/sw-register.js';

const INDEX = readFileSync(resolve(dirname(fileURLToPath(import.meta.url)), '../../app/src/main/assets/index.html'), 'utf8');
