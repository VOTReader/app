...
/* RED — navigation-tabs-4 (Verifier reproduction, 2026-09-03)
   ...
   Lives in tools/repro/ (not beside the source) so the pre-commit vitest gate,
   which fires on staged src/ paths, does not block a tests-only RED commit;
   the fix commit should move it next to screen-routes.jsx. */
import { describe, it, expect, beforeEach, afterEach, vi } from 'vitest';
import { buildScreenRoutes } from '../../app/src/main/assets/src/ui/screen-routes.jsx';
