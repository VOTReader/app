...
try {
  for (const scale of SCALES) {
    ...
    await page.evaluate(() => { const t = [...document.querySelectorAll('.library-tile')].find((t) => (t.querySelector('.library-tile-title') || {}).textContent === 'Notes'); t && t.click(); }); await sleep(700); await setScale();
