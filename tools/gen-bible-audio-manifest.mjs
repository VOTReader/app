...
/* Optional chapter-start index (D:/BibleAudio/scan-chapters.py — narrator
   announcement detection, cross-validated against YouTube comment stamps).
   Emitted only for books whose scan is complete AND monotonic; a book without
   rows simply keeps whole-book-only playback. */
...
/* KJV chapter counts, canonical order — drives the Word of Promise per-chapter
   expansion (1,189 rows would be ~40 KB written out; the loop is ~1 KB). */
...
if (CHAPTER_COUNTS.reduce((a, b) => a + b, 0) !== 1189) throw new Error('chapter counts drifted');
const wopRows = BOOKS66
...
const out = `/* BIBLE AUDIO MANIFEST — auto-generated by tools/gen-bible-audio-manifest.mjs. DO NOT EDIT.
   ...
   book track (index i = chapter i+1; narrator-announcement scan, comment-validated).
