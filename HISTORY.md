...
- **Next:** P2 web I/O (FS Access API export + `File.stream` import, wired through `PlatformBridge` + `SettingsScreen`) → P3 Android native framing + chunked bridge (emulator-verified) → P4 back-compat + cap removal → P5 docs.
