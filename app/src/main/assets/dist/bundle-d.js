(() => {
  ...
  // app/src/main/assets/src/ui/components/HolyDaysPlaylistHeader.jsx
  function HolyDaysPlaylistHeader2() {
...
Continue?`
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "settings-screen" }, /* @__PURE__ */ React.createElement("div", { className: "settings-header" }, /* @__PURE__ */ React.createElement("div", { className: "settings-eyebrow" }, "VOT Study Bible"), /* @__PURE__ */ React.createElement("h1", { className: "settings-title" }, "Settings"), /* @__PURE__ */ React.createElement("div", { className: "settings-ornament" }, /* @__PURE__ */ React.createElement("div", { className: "settings-ornament-line" }), /* @__PURE__ */ React.createElement("div", { className: "settings-ornament-diamond" }), /* @__PURE__ */ React.createElement("div", { className: "settings-ornament-line r" }))), /* @__PURE__ */ React.createElement("div", { className: "settings-section" }, /* @__PURE__ */ React.createElement("div", { className: "settings-section-label" }, "Text & Translation"), /* @__PURE__ */ React.createElement(
        ...
        e.stopPropagation();
        importPersonalData();
      } }, "Import")), diagnosticLog.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "settings-row" }, /* @__PURE__ */ React.createElement("div", { className: "settings-row-text" }, /* @__PURE__ */ React.createElement("div", { className: "settings-row-label" }, "Diagnostic Log"), /* @__PURE__ */ React.createElement("div", { className: "settings-row-desc" }, `${diagnosticLog.length} recent ${diagnosticLog.length === 1 ? "entry" : "entries"} captured (warnings, errors, and timings; content URIs and file paths redacted). Included in your next Export. Last entry: ${new Date(diagnosticLog[diagnosticLog.length - 1].t).toLocaleString()}.`))), /* @__PURE__ */ (() => {
        const closeWipe = () => {
  ...
  function GardenView2({ page, onPageChange, onBack, theme: _theme, onThemeChange: _onThemeChange, tier }) {
    ...
    ), /* @__PURE__ */ React.createElement("span", { className: "garden-jump-hint" }, "/ ", GARDEN_TOTAL)) : /* @__PURE__ */ React.createElement("button", { className: "garden-page-counter", onClick: () => setJumpMode(true) }, page, " / ", GARDEN_TOTAL)), /* @__PURE__ */ React.createElement("div", { className: "garden-image-area", ref: imgAreaRef }, loading && /* @__PURE__ */ React.createElement("div", { className: "garden-loading" }, /* @__PURE__ */ React.createElement("div", { style: { color: "rgba(255,255,255,0.6)", fontSize: "0.9rem" } }, error ? "Failed to load \u2014 check your connection" : `Loading page ${page}...`)), /* @__PURE__ */ React.createElement(
      "img",
      {
        ref: imgElRef,
        key: `${tier}-${page}`,
