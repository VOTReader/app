...
const CORE_ASSETS = [
  ...
  // Reading Font picker previews — ~45 KB of name-glyph subsets
  // (tools/gen-font-previews.mjs) so the picker renders offline. The FULL
  // downloadable fonts are NOT SW-cached: reading-fonts.js owns them in
  // its own 'vot-fonts-v1' bucket (cross-origin CDN fetch, user-opted).
  './fonts/previews/modern.woff2',
  './fonts/previews/lora.woff2',
  './fonts/previews/literata.woff2',
  './fonts/previews/merriweather.woff2',
  './fonts/previews/crimson-pro.woff2',
  './fonts/previews/source-serif-4.woff2',
  './fonts/previews/libre-baskerville.woff2',
  './fonts/previews/cardo.woff2',
  './fonts/previews/gentium-book-plus.woff2',
  './fonts/previews/noto-serif.woff2',
  './fonts/previews/spectral.woff2',
  './fonts/previews/vollkorn.woff2',
  './fonts/previews/alegreya.woff2',
  './fonts/previews/bitter.woff2',
  './fonts/previews/atkinson-hyperlegible.woff2',
  './fonts/previews/lexend.woff2',
  './icons/icon-192.png',
  './icons/icon-512.png',
