...
const CACHE_VERSION = 'v1.0.2-51c68ebefa';
const CORPUS_VERSION = 'c14'; // c13→c14 (2026-07-19): blank-footnote fix — Vol6 "Freedom Comes By Sacrifice" fn1 + Vol7 "Who Among You…" fn7 converted note→scripture ("1 Kings 22"/"Leviticus 23"); bible-studies more-than-a-man-ch5 typo "Matthew 19:36"→"Matthew 19:16" + its NKJV dict value filled. (c12→c13 (2026-07-12): Restored-Name NT — new sparse overlay translations bible-rnkjv.js + bible-rkjv.js (NKJV-R / KJV-R: YahuShua HaMashiach restored across the New Testament; generated by tools/gen-restored-nt.mjs, ruleset in RESTORED-NAMES-PLAN.txt). (c11→c12: WTLB/Blessed faithfulness audit — all 360 entries verified present + complete; included the one editorial clarification footnote on WTLB One "YAHUWAH Is One". c10→c11: restored 14 blank Timothy headers + Recompense's lost dream. c9→c10: restored the "(Regarding …)" occasion header line to ~40 letters. c8→c9: SW1 corpus-cache. c7→c8: CORP-2. c6→c7: CORP-1. c5→c6: PF1 minify.)
