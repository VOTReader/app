...
export const MS_INDEX_VERSION = 'm7';   // m7: letter and study bodies in the reader's text: no footnote numbers, letter-link labels, the renderer's spacing (2026-09-25)
...
export const CORPUS_CONTENT_VERSION = 'c63';
