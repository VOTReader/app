...
vi.mock('../../data/scripture-resolution.js', async (importOriginal) => { const real = /** @type {any} */ (await importOriginal()); return { ...real, get LETTER_SCREEN_SET() { return /** @type {any} */ (globalThis).LETTER_SCREEN_SET; } }; });
