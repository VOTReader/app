...
- **Reading Font picker + Settings accordion** (07-31) — 17-font `READING_FONTS` registry, ~45 KB preview subsets bundled + download-on-demand full fonts (Cache Storage), `--font-body` var plumbing; Settings → 8 collapsed accordion groups, dependent rows unmount.
