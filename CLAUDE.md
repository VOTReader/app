...
- **W0-W10 cross-platform PWA + quality hardening plan** — Phases: W0 prereqs ✅ → W1 PlatformBridge ✅ → W2 IndexedDB ✅ → **W3 PWA shell ✅** → **W4 desktop polish ✅** → **W5 hosting (GitHub Pages) + dual CI ✅** → **W6 cross-platform verification (NEXT)** → W7 quality hardening → W8 type coverage + CSS @layer → W9 data integrity (W9.1 Format A ✅ + W9.2 gate wiring ✅; B/C/D validators + W9.3 import payload remaining) → W10 accessibility. Full per-phase exit criteria + traceability matrix in PLAN.txt.
