...
- **The Scripture Web** (08-11 s11) — OpenBible/TSK dataset vendored (CC-BY) and resolved against the app's own canon into 301,539 verse pairs + 2,097 curated corpus edges; WebGL2 instanced renderer with the height law shared between shader and hit test; analytic tap-anywhere picking; density/colour modes; dual-rail My Web on LinkStore; lazy bundle-f + Library tile; new validateScriptureWeb gate (caught a delta wrap corrupting 286k arcs); c31.
